    ...
    <main className="mx-auto flex min-h-dvh w-full max-w-5xl flex-col gap-6 px-6 py-10">
      <header>
        ...
        <p className="text-sm text-text-secondary">
          Manage identity, security, and workspace preferences tied to your
          VaultChain profile.
        </p>
      </header>
      <section className="grid gap-6 lg:grid-cols-[2fr_1fr]">
        <Card className="border-border/60">
          <CardHeader>
            ...
            <CardDescription>
              Update display name and contact email for trading desks.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="border-border/60 bg-danger/5">
          <CardHeader>
            ...
            <CardDescription>
              Terminate the current session across all devices.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-3">
            <p className="text-sm text-text-secondary">
              Use this when you leave a shared desk or suspect credential
              compromise.
            </p>
